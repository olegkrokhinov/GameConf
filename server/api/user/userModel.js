...
userSchema.statics.findUserAndDoAnActionWithFriend = function (userId, friendId, actionWithFriend) {
  return new Promise((resolve, reject) => {
    this.findById(userId)
      ...
      .then((user) => {
        return user[actionWithFriend](friendId)
      })
      .catch(reject)
      .then(resolve);
  });
